...
const struct TrainerBall gTrainerBallTable[] = {
    ...
    {TRAINER_CLASS_RUIN_MANIAC, ITEM_HEAVY_BALL},
    ...
    {TRAINER_CLASS_HEX_MANIAC, ITEM_MOON_BALL},
    ...
    {TRAINER_CLASS_PSYCHIC, ITEM_MOON_BALL},
    ...
    {TRAINER_CLASS_BIRD_KEEPER, ITEM_FAST_BALL},
    {TRAINER_CLASS_NINJA_BOY, ITEM_FAST_BALL},
